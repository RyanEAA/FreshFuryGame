...
while True:
    ...
    if success:
        ...
        if (0 <= fruit_x < frame.shape[1] - fruit_w) and (0 <= fruit_y < frame.shape[0] - fruit_h):
            ...
            print("Fruit image shape:", fruit_image.shape)
        ...
        if processsed_frame.multi_hand_landmarks:
            ...
            # Append the index finger tip coordinates to the list
            ...
            cv2.circle(frame, (x, y), 10, (255, 0, 0), -1)  # Blue circle with radius 10
